...
class Sql
{
     ...
     */
    static function up() {
        $q1 = "CREATE TABLE users (id INTEGER PRIMARY KEY, user VARCHAR(50), pass VARCHAR(50), email varchar(50), age varchar(50), bio varhar(50), isadmin INTEGER, resetToken varchar(50));";
        ...
        $q6 = "CREATE TABLE throttling (id INTEGER PRIMARY KEY, ip varchar(50), date INTEGER );";
